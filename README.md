...
I (CC) ran `src/plasmerge.py`  (script `test.sh`) on 5 *E. coli* samples and on the ground ruth plasmid bins and the plasmid bins created by `gplas2, MOB-recon, PlasBin-flow`.
