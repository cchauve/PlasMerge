...
- `check_plaseval.sh NB_SAMPLES eval 0 RUN`: checks if PlasEval in `eval` mode results are there;
- `check_plaseval.sh NB_SAMPLES comp ALPHAS RUN`: checks if PlasEval in mode `comp` results are there, with `ALPHAS` being a comma-separated list of values for `alpha`;
...
Checking PlasEval results in `eval` mode.
```
> rm plasmids_benchmarking_2025-08-02_data.filtered.randomized.plaseval.*07.???
> ./check_plaseval.sh 500 eval 0 1
...
> wc -l plasmids_benchmarking_2025-08-02_data.filtered.randomized.plaseval.eval.0.1.2025-09-09.csv
194 plasmids_benchmarking_2025-08-02_data.filtered.randomized.plaseval.eval.0.1.2025-09-09.csv
```
...
Checking PlasEval results in `comp` mode.
```
> ./check_plaseval.sh 500 comp 0.0 1
...
> wc -l plasmids_benchmarking_2025-08-02_data.filtered.randomized.plaseval.comp.0.0.1.2025-09-09.csv
194 plasmids_benchmarking_2025-08-02_data.filtered.randomized.plaseval.comp.0.0.1.2025-09-09.csv
> ./check_plaseval.sh 500 comp 0.5 1
...
> wc -l plasmids_benchmarking_2025-08-02_data.filtered.randomized.plaseval.comp.0.5.1.2025-09-09.csv
194 plasmids_benchmarking_2025-08-02_data.filtered.randomized.plaseval.comp.0.5.1.2025-09-09.csv
> ./check_plaseval.sh 500 comp 1.0 1
...
> wc -l plasmids_benchmarking_2025-08-02_data.filtered.randomized.plaseval.comp.1.0.1.2025-09-09.csv
194 plasmids_benchmarking_2025-08-02_data.filtered.randomized.plaseval.comp.1.0.1.2025-09-09.csv
```

Analysis: `CSV` results files and figures.
```
> rm analysis/* analysis/figures/*
> nohup ./create_plots_all.sh &
> grep -v flexiblas nohup.out > log/create_plots_all.log
