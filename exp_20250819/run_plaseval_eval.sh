...
do
	...
	rm -f ${SLURM_FILE}
	rm -f ${LOG_DIR}/eval_${BINNING}_${CLASSIFICATION}_${MERGED}_*_*.out
	rm -f ${LOG_DIR}/eval_${BINNING}_${CLASSIFICATION}_${MERGED}_*_*.err	
	...
	echo "#SBATCH --job-name=plaseval_eval_${BINNING}_${CLASSIFICATION}_${MERGED}" >> ${SLURM_FILE}
	echo "#SBATCH --array=1-${NB_SAMPLES}" >> ${SLURM_FILE}
	echo "#SBATCH --output=${LOG_DIR}/eval_${BINNING}_${CLASSIFICATION}_${MERGED}_%A_%a.out" >> ${SLURM_FILE}
	echo "#SBATCH --error=${LOG_DIR}/eval_${BINNING}_${CLASSIFICATION}_${MERGED}_%A_%a.err" >> ${SLURM_FILE}
