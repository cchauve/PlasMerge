...
def _create_plaseval_comp_command(sample_data_dict, args):
    ...
    plaseval_cmd = [
        ...
        "--r", sample_data_dict[(GT,classification)],
...
def _check_plaseval_eval(args):
    """ Check PlasEval i eval mode input/output on a set of samples for all combinations (binning,classification,merged_status)
    Input:
    - args: (argparse object) argument for the CHECK_PLASMERGE command
    Output: None
