...
./create_plots.sh scatter analysis/figures analysis/plasmids_benchmarking_2025-08-02_data.filtered.randomized.results.csv
./create_plots.sh difference analysis/figures analysis/plasmids_benchmarking_2025-08-02_data.filtered.randomized.results.csv

logger -s "Creating plots with alpha=0"
./create_plots.sh scatter analysis/figures_0 analysis/plasmids_benchmarking_2025-08-02_data.filtered.randomized.results_0.csv
./create_plots.sh difference analysis/figures_0 analysis/plasmids_benchmarking_2025-08-02_data.filtered.randomized.results_0.csv
