...
UNMERGED_RFPLASMID_FILE=${SAMPLE_INPUT_PLASMERGE_DIR}/${EXP_ID}_${BINNING_RFPLASMID}.${UNMERGED_BINS_SUFFIX}
UNMERGED_PLASCLASS_FILE=${SAMPLE_INPUT_PLASMERGE_DIR}/${EXP_ID}_${BINNING_PLASCLASS}.${UNMERGED_BINS_SUFFIX}
UNMERGED_PLASGRAPH_FILE=${SAMPLE_INPUT_PLASMERGE_DIR}/${EXP_ID}_${BINNING_PLASGRAPH}.${UNMERGED_BINS_SUFFIX}
UNMERGED_MLPLASMIDS_FILE=${SAMPLE_INPUT_PLASMERGE_DIR}/${EXP_ID}_${BINNING_MLPLASMIDS}.${UNMERGED_BINS_SUFFIX}
# Merged bins files
...
run_plaseval.sh \
    ...
    ${GFA_FILE} ${UNMERGED_RFPLASMID_FILE} ${MERGED_RFPLASMID_FILE} \
    ${GT_FILE} \
...
run_plaseval.sh \
    ${PLASEVAL_BIN_DIR} ${PLASMERGE_BIN_DIR} ${SAMPLE_ID} ${ASSEMBLER} ${METHOD} \
    ${GFA_FILE} ${UNMERGED_PLASCLASS_FILE} ${MERGED_PLASCLASS_FILE} \
    ${GT_FILE} \
    ${SAMPLE_OUTPUT_PLASEVAL_DIR} \
    ${MIN_LEN} ${ALPHA} ${MAX_RECURSIVE_CALLS}
...
run_plaseval.sh \
    ${PLASEVAL_BIN_DIR} ${PLASMERGE_BIN_DIR} ${SAMPLE_ID} ${ASSEMBLER} ${METHOD} \
    ${GFA_FILE} ${UNMERGED_PLASGRAPH_FILE} ${MERGED_PLASGRAPH_FILE} \
    ${GT_FILE} \
    ${SAMPLE_OUTPUT_PLASEVAL_DIR} \
    ${MIN_LEN} ${ALPHA} ${MAX_RECURSIVE_CALLS}
...
run_plaseval.sh \
    ${PLASEVAL_BIN_DIR} ${PLASMERGE_BIN_DIR} ${SAMPLE_ID} ${ASSEMBLER} ${METHOD} \
    ${GFA_FILE} ${UNMERGED_MLPLASMIDS_FILE} ${MERGED_MLPLASMIDS_FILE} \
    ${GT_FILE} \
    ${SAMPLE_OUTPUT_PLASEVAL_DIR} \
    ${MIN_LEN} ${ALPHA} ${MAX_RECURSIVE_CALLS}
