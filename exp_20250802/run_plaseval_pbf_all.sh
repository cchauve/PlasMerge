...
#SBATCH --job-name=plaseval_pbf
#SBATCH --array=2-500
#SBATCH --output=log/plaseval/plaseval_pbf_%A_%a.out
#SBATCH --error=log/plaseval/plaseval_pbf_%A_%a.err
...
INPUT_BINNING_RFPLASMID_FILE=${SAMPLE_INPUT_PLASMERGE_DIR}/${EXP_ID}_${BINNING_RFPLASMID}.${UNMERGED_BINS_SUFFIX}
INPUT_BINNING_PLASCLASS_FILE=${SAMPLE_INPUT_PLASMERGE_DIR}/${EXP_ID}_${BINNING_PLASCLASS}.${UNMERGED_BINS_SUFFIX}
INPUT_BINNING_PLASGRAPH_FILE=${SAMPLE_INPUT_PLASMERGE_DIR}/${EXP_ID}_${BINNING_PLASGRAPH}.${UNMERGED_BINS_SUFFIX}
INPUT_BINNING_MLPLASMIDS_FILE=${SAMPLE_INPUT_PLASMERGE_DIR}/${EXP_ID}_${BINNING_MLPLASMIDS}.${UNMERGED_BINS_SUFFIX}
# Merged bins files
MERGED_BINS_SUFFIX=merged_bins.tsv
OUTPUT_BINNING_RFPLASMID_FILE=${SAMPLE_OUTPUT_PLASMERGE_DIR}/${EXP_ID}_${BINNING_RFPLASMID}_${MERGED_BINS_SUFFIX}
OUTPUT_BINNING_PLASCLASS_FILE=${SAMPLE_OUTPUT_PLASMERGE_DIR}/${EXP_ID}_${BINNING_PLASCLASS}_${MERGED_BINS_SUFFIX}
OUTPUT_BINNING_PLASGRAPH_FILE=${SAMPLE_OUTPUT_PLASMERGE_DIR}/${EXP_ID}_${BINNING_PLASGRAPH}_${MERGED_BINS_SUFFIX}
OUTPUT_BINNING_MLPLASMIDS_FILE=${SAMPLE_OUTPUT_PLASMERGE_DIR}/${EXP_ID}_${BINNING_MLPLASMIDS}_${MERGED_BINS_SUFFIX}
...
run_plaseval.sh \
    ...
    ${GFA_FILE} ${INPUT_BINNING_RFPLASMID_FILE} ${OUTPUT_BINNING_RFPLASMID_FILE} \
    ${GT_FILE} \
...
run_plaseval.sh \
    ${PLASEVAL_BIN_DIR} ${PLASMERGE_BIN_DIR} ${SAMPLE_ID} ${ASSEMBLER} ${METHOD} \
    ${GFA_FILE} ${INPUT_BINNING_PLASCLASS_FILE} ${OUTPUT_BINNING_PLASCLASS_FILE} \
    ${GT_FILE} \
    ${SAMPLE_OUTPUT_PLASEVAL_DIR} \
    ${MIN_LEN} ${ALPHA} ${MAX_RECURSIVE_CALLS}
...
run_plaseval.sh \
    ${PLASEVAL_BIN_DIR} ${PLASMERGE_BIN_DIR} ${SAMPLE_ID} ${ASSEMBLER} ${METHOD} \
    ${GFA_FILE} ${INPUT_BINNING_PLASGRAPH_FILE} ${OUTPUT_BINNING_PLASGRAPH_FILE} \
    ${GT_FILE} \
    ${SAMPLE_OUTPUT_PLASEVAL_DIR} \
    ${MIN_LEN} ${ALPHA} ${MAX_RECURSIVE_CALLS}
...
run_plaseval.sh \
    ${PLASEVAL_BIN_DIR} ${PLASMERGE_BIN_DIR} ${SAMPLE_ID} ${ASSEMBLER} ${METHOD} \
    ${GFA_FILE} ${INPUT_BINNING_MLPLASMIDS_FILE} ${OUTPUT_BINNING_MLPLASMIDS_FILE} \
    ${GT_FILE} \
    ${SAMPLE_OUTPUT_PLASEVAL_DIR} \
    ${MIN_LEN} ${ALPHA} ${MAX_RECURSIVE_CALLS}
