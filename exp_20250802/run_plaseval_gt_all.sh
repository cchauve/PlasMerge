...
#SBATCH --job-name=plaseval_gt
#SBATCH --array=2-500
#SBATCH --output=log/plaseval/plaseval_gt_%A_%a.out
#SBATCH --error=log/plaseval/plaseval_gt_%A_%a.err
...
# Unmerged bins (ground truth) file
