...
INPUT_BINNING_FILE=${SAMPLE_INPUT_PLASMERGE_DIR}/${EXP_ID}_${BINNING}.tsv
# Merged bins files
...
run_plaseval.sh \
    ...
    ${GFA_FILE} ${INPUT_BINNING_FILE} ${OUTPUT_BINNING_RFPLASMID_FILE} \
    ${GT_FILE} \
...
run_plaseval.sh \
    ${PLASEVAL_BIN_DIR} ${PLASMERGE_BIN_DIR} ${SAMPLE_ID} ${ASSEMBLER} ${METHOD} \
    ${GFA_FILE} ${INPUT_BINNING_FILE} ${OUTPUT_BINNING_PLASCLASS_FILE} \
    ${GT_FILE} \
    ${SAMPLE_OUTPUT_PLASEVAL_DIR} \
    ${MIN_LEN} ${ALPHA} ${MAX_RECURSIVE_CALLS}
...
run_plaseval.sh \
    ${PLASEVAL_BIN_DIR} ${PLASMERGE_BIN_DIR} ${SAMPLE_ID} ${ASSEMBLER} ${METHOD} \
    ${GFA_FILE} ${INPUT_BINNING_FILE} ${OUTPUT_BINNING_PLASGRAPH_FILE} \
    ${GT_FILE} \
    ${SAMPLE_OUTPUT_PLASEVAL_DIR} \
    ${MIN_LEN} ${ALPHA} ${MAX_RECURSIVE_CALLS}
...
run_plaseval.sh \
    ${PLASEVAL_BIN_DIR} ${PLASMERGE_BIN_DIR} ${SAMPLE_ID} ${ASSEMBLER} ${METHOD} \
    ${GFA_FILE} ${INPUT_BINNING_FILE} ${OUTPUT_BINNING_MLPLASMIDS_FILE} \
    ${GT_FILE} \
    ${SAMPLE_OUTPUT_PLASEVAL_DIR} \
    ${MIN_LEN} ${ALPHA} ${MAX_RECURSIVE_CALLS}
